...
export default function decorate(block) {
  ...
  imageWrapperDiv.style.background = `url(${backgroundImage}) , linear-gradient(to bottom, rgb(75, 76, 77) 0%, rgba(93, 93, 93, 0.65) 29%, rgba(115, 115, 115, 0.2) 100%) !important`;
